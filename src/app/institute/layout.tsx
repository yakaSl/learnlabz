...
import { Sidebar, SidebarContent, SidebarFooter, SidebarHeader, SidebarInset, SidebarMenu, SidebarMenuItem, SidebarMenuButton, SidebarProvider, SidebarTrigger, SidebarMenuSub, SidebarMenuSubItem, SidebarMenuSubButton } from "@/components/ui/sidebar";
  ...
  const renderMenuItem = (item: MenuItem) => {
                  ...
                  return (
                    <SidebarMenuSubItem key={child.menu_code}>
                      <SidebarMenuSubButton asChild>
                        <Link href={`/institute${child.path}`}>
    ...
    return (
      <SidebarMenuItem key={item.menu_code}>
        <Link href={`/institute${item.path}`} passHref>
          <SidebarMenuButton tooltip={item.menu_name}>
            <Icon />
            <span>{item.menu_name}</span>
          </SidebarMenuButton>

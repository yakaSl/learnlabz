...
export const attendanceData: AttendanceRecord[] = [
  ...
  { date: new Date(year, month, 3).toISOString(), status: 'Present', class: 'Physics for Beginners' },
  ...
  { date: new Date(year, month, 5).toISOString(), status: 'Present', class: 'Physics for Beginners' },
  ...
  { date: new Date(year, month, 10).toISOString(), status: 'Excused', class: 'Physics for Beginners', reason: "Family emergency", tutorComment: "Parent called." },
  { date: new Date(year, month, 11).toISOString(), status: 'Present', class: 'Algebra 101' },
  { date: new Date(year, month, 12).toISOString(), status: 'Late', class: 'Physics for Beginners', tutorComment: "Arrived 5 minutes late." },
];

    ...
    return (
        <TooltipProvider>
            <Tooltip>
                ...
                <TooltipContent>
                    <p>{isLocked ? `Locked: ${badge.description}` : `Unlocked: ${badge.description}`}</p>
                </TooltipContent>
            </Tooltip>
        </TooltipProvider>
    );
...
export function BadgeGallery() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Alex's Badge Collection</CardTitle>
        <CardDescription>A gallery of earned and potential badges.</CardDescription>
      </CardHeader>
      <CardContent>
